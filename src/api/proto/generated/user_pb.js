...
goog.exportSymbol('proto.proto.UserUpdateRoleRequest', null, global);
goog.exportSymbol('proto.proto.UserUpdateRoleResponse', null, global);
/**
 ...
 * @constructor
 */
proto.proto.UserUpdateRoleRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.UserUpdateRoleRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.UserUpdateRoleRequest.displayName = 'proto.proto.UserUpdateRoleRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.proto.UserUpdateRoleResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.UserUpdateRoleResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.UserUpdateRoleResponse.displayName = 'proto.proto.UserUpdateRoleResponse';
}
 ...
 * @return {!Object}
 */
proto.proto.UserUpdateRoleRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.UserUpdateRoleRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.UserUpdateRoleRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserUpdateRoleRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    uuid: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.UserUpdateRoleRequest}
 */
proto.proto.UserUpdateRoleRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.UserUpdateRoleRequest;
  return proto.proto.UserUpdateRoleRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.UserUpdateRoleRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.UserUpdateRoleRequest}
 */
proto.proto.UserUpdateRoleRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.UserUpdateRoleRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.UserUpdateRoleRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.UserUpdateRoleRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserUpdateRoleRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUuid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.proto.UserUpdateRoleRequest.prototype.getUuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.proto.UserUpdateRoleRequest} returns this
 */
proto.proto.UserUpdateRoleRequest.prototype.setUuid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.proto.UserUpdateRoleRequest.prototype.getRole = function() {
 ...
 * @return {!proto.proto.UserUpdateRoleRequest} returns this
 */
proto.proto.UserUpdateRoleRequest.prototype.setRole = function(value) {
 ...
 * @return {boolean}
 */
proto.proto.UserUpdateRoleRequest.prototype.getEnabled = function() {
 ...
 * @return {!proto.proto.UserUpdateRoleRequest} returns this
 */
proto.proto.UserUpdateRoleRequest.prototype.setEnabled = function(value) {
 ...
 * @return {!Object}
 */
proto.proto.UserUpdateRoleResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.UserUpdateRoleResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.UserUpdateRoleResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserUpdateRoleResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: (f = msg.getUser()) && proto.proto.User.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.UserUpdateRoleResponse}
 */
proto.proto.UserUpdateRoleResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.UserUpdateRoleResponse;
  return proto.proto.UserUpdateRoleResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.UserUpdateRoleResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.UserUpdateRoleResponse}
 */
proto.proto.UserUpdateRoleResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.UserUpdateRoleResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.UserUpdateRoleResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.UserUpdateRoleResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserUpdateRoleResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUser();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.proto.User}
 */
proto.proto.UserUpdateRoleResponse.prototype.getUser = function() {
  return /** @type{?proto.proto.User} */ (
    jspb.Message.getWrapperField(this, proto.proto.User, 1));
};
...
/**
 * @param {?proto.proto.User|undefined} value
 * @return {!proto.proto.UserUpdateRoleResponse} returns this
*/
proto.proto.UserUpdateRoleResponse.prototype.setUser = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.proto.UserUpdateRoleResponse} returns this
 */
proto.proto.UserUpdateRoleResponse.prototype.clearUser = function() {
  return this.setUser(undefined);
};
 ...
 * @return {boolean}
 */
proto.proto.UserUpdateRoleResponse.prototype.hasUser = function() {
  return jspb.Message.getField(this, 1) != null;
};
